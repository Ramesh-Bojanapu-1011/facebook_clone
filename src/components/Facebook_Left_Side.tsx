        ...
        <li className="p-2 flex items-center gap-3 hover:bg-gray-100 rounded-lg cursor-pointer">
          ...
          >
            ...
            <path
              ...
              d="M13.227 20.145C20.917 8.29 32.017 0 44.746 0C52.118 0 59.447 2.182 67.1 8.43c8.371 6.833 17.294 18.083 28.425 36.624l3.99 6.654c9.636 16.051 15.118 24.309 18.326 28.203c4.126 5.001 7.016 6.492 10.77 6.492c9.521 0 11.897-8.75 11.897-18.763l14.799-.464c0 10.467-2.063 18.157-5.574 24.233c-3.392 5.876-10.002 11.747-21.123 11.747c-6.913 0-13.037-1.501-19.81-7.89c-5.206-4.904-11.293-13.616-15.976-21.447L78.896 50.552c-6.99-11.677-13.4-20.383-17.11-24.326c-3.992-4.24-9.122-9.36-17.31-9.36c-6.627 0-12.255 4.651-16.964 11.764z"
            ></path>
            <path
              fill="url(#SVGkdv8EcyD)"
              d="M44.476 16.867c-6.627 0-12.255 4.65-16.964 11.763c-6.66 10.05-10.737 25.022-10.737 39.399c0 5.93 1.302 10.483 3.003 13.237l-14.302 9.42C1.804 84.577 0 76.562 0 67.43c0-16.608 4.558-33.918 13.227-47.285C20.917 8.29 32.017 0 44.746 0z"
            ></path>
            <path
              fill="#192830"
