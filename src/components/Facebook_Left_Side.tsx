...
const Facebook_Left_Side = () => {
  return (
    <div className=" flex flex-col p-4 space-y-4  w-[300px] bg-gray-200  ">
      <ul className=" flex flex-col space-y-2">
        <li className=" flex items-center p-2 hover:bg-gray-100 rounded-lg cursor-pointer">
          <Image
            ...
            width={40}
            height={40}
            className="rounded-full size-10 object-center object-contain"
          />
          <span className="ml-2">Ramesh Bojanapu</span>
        </li>
        <li className="p-2 flex items-center gap-3 hover:bg-gray-100 rounded-lg cursor-pointer">
          <svg
        ...
        <li className="p-2 flex items-center gap-5 hover:bg-gray-100 rounded-lg cursor-pointer">
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={21.43}
...
export default Facebook_Left_Side;
